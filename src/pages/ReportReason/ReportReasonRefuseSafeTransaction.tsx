...
const ReportReasonRefuseSafeTransaction = () => {
    const navigate = useNavigate();
    const location = useLocation();
    const selectedCategory = location.state?.category || "안전한 거래를 거부해요";
    const itemId = location.state?.itemId;
    const settings = ["현금 거래 및 외부채널 유도", "배송완료 전 거래완료 요청", "거래 완료 후, 추가 금액 요청"];
...
export default ReportReasonRefuseSafeTransaction;
