        ...
        <>
            ...
            <TermDescList>
                <li>
                    ...
                    내에서만 처리하며, 정보주체의 동의 또는 법령에 따라 제3자에게 제공할 수
                    있습니다.
                </li>
                <li>
                    “반띵”은 개인위치정보를 제3자에게 제공하지 않습니다. 다만, 사용자가 상품을
                    등록하면서 직거래를 선택하고 작성완료에 한하여, 구매자가 거래 편의를 위해 해당
                    상품 등록자의 대략적인 위치 정보를 확인할 수 있습니다. 이 경우, 제공되는 위치
                    정보는 구체적인 세부 위치가 아닌, 특정 지역을 나타내는 범위로 제한됩니다.
                </li>
            </TermDescList>
